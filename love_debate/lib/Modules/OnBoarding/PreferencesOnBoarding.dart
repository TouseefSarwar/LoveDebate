        ...
        actions: <Widget>[
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                AnswersGlobal.questions.forEach((element) { print(element.qaAns);});
              },
              child: Text(
                "Save" ,
                style: TextStyle(
...
//            AnswersGlobal.questionIndex = index;
            return PreferenceQuestion(
              ...
              ans: AnswersGlobal.questions[index].qaAns == null?Text(
                "Answer",
                style: TextStyle(
...
//              ans: AnswersGlobal.questions[index].qaAns == null? "Answer" : AnswersGlobal.questions[index].qaAns,
              action: (){
