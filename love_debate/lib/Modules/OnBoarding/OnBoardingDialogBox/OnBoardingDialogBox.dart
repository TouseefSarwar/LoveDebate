    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 16,),
          Container(
            height:((questionOptionsLenght)+1.toDouble())*60,
            //height: (((questionsCheckBox.length)+1).toDouble())*60,
            child: ListView.builder(
              // itemCount: (questionsCheckBox.length),
                itemCount:(questionOptionsLenght),
                itemBuilder: (BuildContext context,int index,){
                  String itm = opt.myKey[index].text.toString();
                  return OnBoardingCheckBox(itm,totalDialogWidth,questionsCheckBox,index,apiItemLenght);
                }),
          ),
          Container(
            //height: 100,
...
//                  apiCall=0;
//                  apiQuestionsCheckBox=questionsCheckBox;
//                  apiItemLenght=apiQuestionsCheckBox.length;
                });
