...
class MatchListingCell extends StatelessWidget {
  double height;
  double width;
  String title;
  String age;
  ...
  String data;
  MatchListingCell({this.height, this.width, this.data,this.address ,this.avatarColor, this.iconColor, this.title, this.age, this.gender,this.personHeight,this.index, this.action});
