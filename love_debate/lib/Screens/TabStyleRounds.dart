...
class _CurrentRoundsState extends State<CurrentRounds>with SingleTickerProviderStateMixin {
      ...
      body: SafeArea(
        child: Column(
          children: <Widget>[
            TabBar(
              tabs: <Widget>[
                Tab(child: Text("Round 1",style: TextStyle(color: Colors.black),),),
                Tab(child: Text("Round 2",style: TextStyle(color: Colors.black),),),
                Tab(child: Text("Round 3",style: TextStyle(color: Colors.black),),),
              ],
              controller: tabController,
            ),
            Container(
